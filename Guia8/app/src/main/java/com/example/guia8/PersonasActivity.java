...
import com.example.guia8.modelos.Persona;
    ...
    private void initialize() {
        ...
        listPersonas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getBaseContext(), com.example.guia8.AddPersonaActivity.class);
        ...
        listPersonas.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(com.example.guia8.PersonasActivity.this);
                alert.setMessage("¿Está seguro que desea eliminar el registro?")
                        .setTitle("Confirmación");

                alert.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        com.example.guia8.PersonasActivity.refPersonas
                                .child(personas.get(position).getKey()).removeValue();

                        Toast.makeText(com.example.guia8.PersonasActivity.this,
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), com.example.guia8.AddPersonaActivity.class);
        ...
        consultaOrdenada.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdaptadorPersona adapter = new AdaptadorPersona(com.example.guia8.PersonasActivity.this,
                        personas );
